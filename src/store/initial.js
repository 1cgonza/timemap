...
const initial = {
  ...
  app: {
    ...
    timeline: {
      ...
      range: [new Date(2020, 7, 6, 12), new Date(2020, 10, 1, 12)],
  ...
  ui: {
    ...
    style: {
      categories: {
        ...
        'Disparo asociado a presencia de policía': '#c950d8',
        'Policía disparando': '#dc8f4c',
        'Disparo sin referencia de origen': '#60c0d2',
        Muerto: '#de2c10',
      },
      narratives: {
        default: {
